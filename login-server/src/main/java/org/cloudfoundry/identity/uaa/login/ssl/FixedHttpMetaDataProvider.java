/*
 * Cloud Foundry 2014.01.06
 * Copyright (c) [2009-2014] Pivotal Software Inc, Inc. All Rights Reserved.
 *
...
/**
 * This class works around the problem described in {@link https://issues.apache.org/jira/browse/HTTPCLIENT-646}
 * when a socket factory is set on the OpenSAML {@link HTTPMetadataProvider#setSocketFactory(ProtocolSocketFactory)}
 * all subsequent GET Methods should be executed using a relative URL, otherwise the HttpClient 
...
public class FixedHttpMetaDataProvider extends HTTPMetadataProvider {
     ...
     * This works around 
     * https://issues.apache.org/jira/browse/HTTPCLIENT-646
     * {@inheritDoc}
     */
    @Override
