 ...
 <div class="splash">
  ...
  <div class="splash-box-blank">
   <div class="container">
    ...
    <p class="next">
     You may go to the <a href="${links.home}">Cloud Foundry console</a>,
     <br />your <a href="${rootUrl}profile">account settings</a>, or <a
      href="${rootUrl}logout.do">logout</a>.
    </p>
    <c:if test="${error!=null}">
     <p class="error" title="${fn:escapeXml(error)}">
      Error: <a href="${links.login}">please try again</a>
     </p>
    </c:if>
   </div>
  </div>
