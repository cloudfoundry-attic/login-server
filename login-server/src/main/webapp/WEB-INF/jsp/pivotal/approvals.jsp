        ...
        <div class="main-content approvals-container">
            ...
            <c:if test="${error==null}">
                ...
                <div class="account-info">
                    <div class="h2">
                        Username: ${fn:escapeXml(pageContext.request.userPrincipal.name)}
                    </div>
                    <div class="h2">
                        Password: **********
                        <a href="${links.passwd}">Reset Password</a>
                    </div>
                </div>
                ...
                <c:if test="${! empty approvals}">
                    ...
                    <div class="application-approvals">
                        ...
                        <p>These applications have been granted access to your account.</p>
                            ...
                            <form action="profile" method="post">
                                ...
                                <div class="approved-app">
                                    ...
                                    <div class="approved-app-actions">
                                        ...
                                        <button class="btn-link" title="Delete" type='submit' name="delete">
                                            <i class="icon-remove-sign"></i>
                                        </button>
                                    </div>

                                    <button class="revoke-access-action btn-link hidden" title="Delete" type='submit' name="delete">
                                        Revoke access
                                    </button>
                                    ...
                                    <div class="permissions-container hidden">
                                        <div class="permissions">
                                            <c:forEach items="${client.value}" var="approval">
                                                <div class="approvals-list-div">
                                                    <input type="checkbox" name="checkedScopes" id="checkbox.scope.${count}"
                                        ...
                                        <div class="actions-update">
                                            <button class="btn-primary btn-small" name="update" type="submit">Update</button>
                                        </div>
