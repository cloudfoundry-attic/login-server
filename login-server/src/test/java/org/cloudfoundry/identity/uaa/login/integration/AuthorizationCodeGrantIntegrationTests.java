...
public class AuthorizationCodeGrantIntegrationTests {
    ...
    // TODO: re-instate this when test accounts can be set up on a different
    // server
    // @Rule
    // public TestAccountSetup testAccountSetup =
    // TestAccountSetup.standard(serverRunning, testAccounts);
