...
public class ServerRunning implements MethodRule, RestTemplateHolder, UrlHelper {
    ...
    public ResponseEntity<Void> getForResponse(String path, MultiValueMap<String, String> params,
                    final HttpHeaders headers, Object... uriVariables) {
        HttpEntity<Void> request = new HttpEntity<Void>(null, headers);
        ...
        return client.exchange(builder.buildString(), HttpMethod.GET, request, Void.class, uriVariables);
    }
