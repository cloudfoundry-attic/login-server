...
<c:choose>
	<c:when test="<%=(((HttpServletRequest)pageContext.getRequest()).getUserPrincipal()) instanceof ExpiringUsernameAuthenticationToken %>">
	...
	<c:when test="<%=(((HttpServletRequest)pageContext.getRequest()).getUserPrincipal()) instanceof UsernamePasswordAuthenticationToken %>">
